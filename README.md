...
Another update: Use keyboard-layout-editor.com to create your layout, then use https://qmk.fm/converter/ to turn it into info.json. They didn't put it on their wiki, so I had to go looking for it.
